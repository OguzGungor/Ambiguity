...
public class DataManager {
   ...
   public void reset() {
      // currMap = new
      // Block[gameObjectManager.getMaps()[0].getMap(mapID).length][gameObjectManager.getMaps()[0].getMap(mapID)[0].length];
      // for(int i = 0 ; i < gameObjectManager.getMaps()[0].getMap(mapID).length ;
      // i++){
      // for(int j = 0 ; j < gameObjectManager.getMaps()[0].getMap(mapID)[0].length ;
      // j++){
   ...
   public void setMapType(int mapID) {
      this.mapID = mapID;
      currMap = new Block[gameObjectManager.getMaps()[0]
            .getMap(mapID).length][gameObjectManager.getMaps()[0].getMap(mapID)[0].length];
      ...
      if (mapID == 1) {
         ...
         ////// test//////////////////
         // currMap[gameObjectManager.getMaps()[0].getMap(mapID).length -
         // 2][gameObjectManager.getMaps()[0].getMap(mapID)[0].length - 5].setEvent(2);
         // currMap[1][gameObjectManager.getMaps()[0].getMap(mapID)[0].length -
         // 5].setEvent(4);
         // currMap[gameObjectManager.getMaps()[0].getMap(mapID).length -
         // 2][4].setEvent(6);
         ...
         currMap[gameObjectManager.getMaps()[0].getMap(mapID).length
               - 1][gameObjectManager.getMaps()[0].getMap(mapID)[0].length - 1].setPlayer(4);
         currMap[gameObjectManager.getMaps()[0].getMap(mapID).length
               - 1][gameObjectManager.getMaps()[0].getMap(mapID)[0].length - 1].setFigureID(4);
         currMap[gameObjectManager.getMaps()[0].getMap(mapID).length
               - 1][gameObjectManager.getMaps()[0].getMap(mapID)[0].length - 1].setEvent(1);
         currMap[gameObjectManager.getMaps()[0].getMap(mapID).length
               - 1][gameObjectManager.getMaps()[0].getMap(mapID)[0].length - 1].setPathNo(1);
         ...
         for (int i = 0; i < 12; i++) {
            ...
            for (int j = 0; j < 6; j++) {
               ...
               // while(direction != occupiedDirection && direction >
               // (occupiedDirection-1)*0.25)
